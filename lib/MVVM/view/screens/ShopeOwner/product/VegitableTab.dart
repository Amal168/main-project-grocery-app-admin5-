...
class Vegitabletab extends StatefulWidget {
  const Vegitabletab({super.key});

  @override
  State<Vegitabletab> createState() => _CustomerRiceTabState();
}

class _CustomerRiceTabState extends State<Vegitabletab> {
  String radiobuttion = " ";
  int selectIndex = 0;
  List vegitable = ["All","loose", "singleOrder", "preoder"];
