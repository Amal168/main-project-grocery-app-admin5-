...
class Spicetab extends StatefulWidget {
  const Spicetab({super.key});

  @override
  State<Spicetab> createState() => _SpicetabState();
}

class _SpicetabState extends State<Spicetab> {
  String radiobuttion = " ";
  int selectIndex = 0;
  List spice = ["All","Packeted", "loose"];
